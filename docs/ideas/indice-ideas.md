...
_(Sin ideas sin procesar ahora. En análisis (ficha en `docs/ideas/`): `ventana-inspector-organismo.md`. Implementadas y archivadas:
`archivo/colorear-por-simplificacion.md` · `archivo/diversidad-inicial-viabilidad.md`.)_
---
